...
declare const Client: typeof IgniteClient & import("./helpers").Constructor<{
    ...
    ChinChin: {
        query: import("./chin.chin/rest").Api<unknown>;
        tx: {
            sendQueryParamsResponse({ value, fee, memo }: {
                value: import("./chin.chin/module").QueryParamsResponse;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendMsgUpdateParams({ value, fee, memo }: {
                value: import("./chin.chin/module").MsgUpdateParams;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendParams({ value, fee, memo }: {
                value: import("./chin.chin/module").Params;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendQueryParamsRequest({ value, fee, memo }: {
                value: import("./chin.chin/module").QueryParamsRequest;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendGenesisState({ value, fee, memo }: {
                value: import("./chin.chin/module").GenesisState;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            sendMsgUpdateParamsResponse({ value, fee, memo }: {
                value: import("./chin.chin/module").MsgUpdateParamsResponse;
                fee?: import("@cosmjs/amino").StdFee;
                memo?: string;
            }): Promise<import("@cosmjs/stargate").DeliverTxResponse>;
            queryParamsResponse({ value }: {
