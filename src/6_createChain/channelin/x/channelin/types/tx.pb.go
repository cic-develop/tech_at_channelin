...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_37f9667faf0fcd37, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_37f9667faf0fcd37, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "channelin.channelin.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "channelin.channelin.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("channelin/channelin/tx.proto", fileDescriptor_37f9667faf0fcd37) }

var fileDescriptor_37f9667faf0fcd37 = []byte{
	// 318 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x49, 0xce, 0x48, 0xcc,
	0xcb, 0x4b, 0xcd, 0xc9, 0xcc, 0xd3, 0x47, 0xb0, 0x4a, 0x2a, 0xf4, 0x0a, 0x8a, 0xf2, 0x4b, 0xf2,
	...
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x50, 0x19, 0x7b, 0x3a, 0x44, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/channelin.channelin.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/channelin.channelin.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "channelin.channelin.Msg",
	...
	Metadata: "channelin/channelin/tx.proto",
}
