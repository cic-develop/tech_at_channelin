...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryMath = (name: string, params: RequestParams = {}) =>
    this.request<{ number?: string }, { code?: number; message?: string; details?: { "@type"?: string }[] }>({
   ...
   */
  queryPlus = (number: string, params: RequestParams = {}) =>
    this.request<{ number?: string }, { code?: number; message?: string; details?: { "@type"?: string }[] }>({
  ...
  querySayHello = (name: string, params: RequestParams = {}) =>
    this.request<{ name?: string }, { code?: number; message?: string; details?: { "@type"?: string }[] }>({
