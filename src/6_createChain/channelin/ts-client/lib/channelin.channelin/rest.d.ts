...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
    queryMath: (name: string, params?: RequestParams) => Promise<AxiosResponse<{
        number?: string;
    }>>;
    /**
     * No description
     ...
     */
    queryPlus: (number: string, params?: RequestParams) => Promise<AxiosResponse<{
        number?: string;
    }>>;
    /**
     * No description
     ...
     */
    querySayHello: (name: string, params?: RequestParams) => Promise<AxiosResponse<{
        name?: string;
    }>>;
}
