...
const (
	Query_Params_FullMethodName = "/chin.chin.Query/Params"
	Query_Hello_FullMethodName  = "/chin.chin.Query/Hello"
)
...
func (c *queryClient) Hello(ctx context.Context, in *QueryHelloRequest, opts ...grpc.CallOption) (*QueryHelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Hello_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Hello(context.Context, *QueryHelloRequest) (*QueryHelloResponse, error) {
...
func _Query_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_Hello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
