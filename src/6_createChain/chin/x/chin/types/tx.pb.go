...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_4412d3728d45d26f, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4412d3728d45d26f, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "chin.chin.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "chin.chin.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("chin/chin/tx.proto", fileDescriptor_4412d3728d45d26f) }

var fileDescriptor_4412d3728d45d26f = []byte{
	...
	0xf1, 0xeb, 0x96, 0xfc, 0xf4, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chin.chin.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chin.chin.Msg/UpdateParams",
	}
